...
var Input = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(field_1["default"], { name: name, validate: validate, fast: fast }, function (_a) {
        ...
        return (React.createElement(antd_1.Input, tslib_1.__assign({ ref: ref, name: name, id: name, value: value, onChange: function (event) {
                onChange(event);
...
TypedInput.Password = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(field_1["default"], { name: name, validate: validate, fast: fast }, function (_a) {
        var _b = _a.field, value = _b.value, onChange = _b.onChange, onBlur = _b.onBlur;
        return (React.createElement(antd_1.Input.Password, tslib_1.__assign({ ref: ref, name: name, id: name, value: value, onChange: function (event) {
                onChange(event);
                $onChange && $onChange(event);
            }, onBlur: function (event) {
                onBlur(event);
...
TypedInput.TextArea = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(field_1["default"], { name: name, validate: validate, fast: fast }, function (_a) {
        var _b = _a.field, value = _b.value, onChange = _b.onChange, onBlur = _b.onBlur;
        return (React.createElement(antd_1.Input.TextArea, tslib_1.__assign({ ref: ref, name: name, id: name, value: value, onChange: function (event) {
                onChange(event);
                $onChange && $onChange(event);
            }, onBlur: function (event) {
                onBlur(event);
