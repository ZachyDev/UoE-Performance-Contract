...
export const Mentions = (_a) => {
    ...
    return (React.createElement(Field, { name: name, validate: validate, fast: fast }, ({ field: { value, onChange, onBlur }, form }) => (React.createElement($Mentions, Object.assign({ name: name, id: name, value: value, onChange: (event) => {
